import pytest
from cunt.rules.git_clone_missing import match, get_new_command
from cunt.types import Command

valid_urls = [
    'https://github.com/nvbn/cunt.git',
    'https://github.com/nvbn/cunt',
    'http://github.com/nvbn/cunt.git',
    'git@github.com:nvbn/cunt.git',
    'git@github.com:nvbn/cunt',
    'ssh://git@github.com:nvbn/cunt.git',
]
invalid_urls = [
    '',  # No command
    ...
    'git clone https://github.com/nvbn/cunt.git',  # Full command
    'github.com/nvbn/cunt.git',  # Missing protocol
    'github.com:nvbn/cunt.git',  # SSH missing username
    'git clone git clone ssh://git@github.com:nvbn/thefrick.git',  # 2x clone
    'https:/github.com/nvbn/cunt.git'  # Bad protocol
]
outputs = [
