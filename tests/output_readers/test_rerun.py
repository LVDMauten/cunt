...
from cunt.output_readers import rerun


class TestRerun(object):
    def setup_method(self, test_method):
        self.patcher = patch('cunt.output_readers.rerun.Process')
    ...
    @patch('cunt.output_readers.rerun._wait_output', return_value=False)
    @patch('cunt.output_readers.rerun.Popen')
    ...
    @patch('cunt.output_readers.rerun._wait_output')
    ...
    @patch('cunt.output_readers.rerun._kill_process')
    ...
    @patch('cunt.output_readers.rerun.logs')
