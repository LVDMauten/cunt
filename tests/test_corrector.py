...
from cunt import corrector, const
from cunt.system import Path
from cunt.types import Command
from cunt.corrector import get_corrected_commands, organize_commands


@pytest.fixture
def glob(mocker):
    results = {}
    mocker.patch('cunt.system.Path.glob',
...
class TestGetRules(object):
    ...
    def load_source(self, monkeypatch):
        monkeypatch.setattr('cunt.types.load_source',
                            lambda x, _: Rule(x))
...
def test_get_corrected_commands(mocker):
    ...
    rules = [Rule(match=lambda _: False),
             ...
             Rule(match=lambda _: True,
                  ...
                  priority=60)]
    mocker.patch('cunt.corrector.get_rules', return_value=rules)
