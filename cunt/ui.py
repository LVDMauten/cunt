...
class CommandSelector(object):
    ...
    def __init__(self, commands):
        """:type commands: Iterable[cunt.types.CorrectedCommand]"""
    ...
    @property
    def value(self):
        """:rtype cunt.types.CorrectedCommand"""
...
def select_command(corrected_commands):
    ...
    :type corrected_commands: Iterable[cunt.types.CorrectedCommand]
    :rtype: cunt.types.CorrectedCommand | None

    """
    try:
        selector = CommandSelector(corrected_commands)
    except NoRuleMatched:
        logs.failed("You're a bit of a cunt, aren't you?" if get_alias() == 'cunt'
                    else 'Nothing found')
        return
