from cunt.specific.npm import npm_available
from cunt.utils import replace_argument, for_app, eager, get_closest
from cunt.specific.sudo import sudo_support
